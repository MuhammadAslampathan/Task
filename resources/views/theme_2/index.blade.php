...
<div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <div class="sidebar-header d-flex align-items-center"><a href="pages-profile.html">
            <div class="avatar"><img src="{{asset('assets/img/avatar-6.jpg')}}" alt="..." class="img-fluid rounded-circle"></div></a>
          <div class="title">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="#pagesDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-website"></i>Pages </a>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="{{asset('assets/img/avatar-1.jpg')}}" alt="..." class="img-fluid">
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="{{asset('assets/img/avatar-4.jpg')}}" alt="..." class="img-fluid">
              ...
              <div class="col-lg-4">
                <div class="user-block block text-center">
                  <div class="avatar"><img src="{{asset('assets/img/avatar-6.jpg')}}" alt="..." class="img-fluid">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="{{asset('assets/img/avatar-1.jpg')}}" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Tomas Hecktor</strong><span class="d-block">@tomhecktor</span></a>
                </div>
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="{{asset('assets/img/avatar-2.jpg')}}" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Alexander Shelby</strong><span class="d-block">@alexshelby</span></a>
                </div>
                <div class="col-lg-4 text-center">
            ...
            <div class="public-user-block block">
              <div class="row d-flex align-items-center">                   
                <div class="col-lg-4 d-flex align-items-center">
                  ...
                  <div class="avatar"> <img src="{{asset('assets/img/avatar-6.jpg')}}" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Arther Kooper</strong><span class="d-block">@artherkooper</span></a>
                </div>
                <div class="col-lg-4 text-center">
              ...
              <div class="col-lg-6">                                           
                <div class="messages-block block">
                  ...
                  <div class="messages"><a href="#" class="message d-flex align-items-center">
                      <div class="profile"><img src="../../../d19m59y37dris4.cloudfront.net/dark-admin-premium/1-4-6/img/avatar-3.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="../../../d19m59y37dris4.cloudfront.net/dark-admin-premium/1-4-6/img/avatar-2.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="../../../d19m59y37dris4.cloudfront.net/dark-admin-premium/1-4-6/img/avatar-1.jpg" alt="..." class="img-fluid">
                      ...
                      <div class="profile"><img src="../../../d19m59y37dris4.cloudfront.net/dark-admin-premium/1-4-6/img/avatar-5.jpg" alt="..." class="img-fluid">
        ...
        <footer class="footer">
          <div class="footer__block block no-margin-bottom">
            <div class="container-fluid text-center">
              <p class="no-margin-bottom">2020 &copy; Your company. </p>
            </div>
          </div>
        </footer>
      </div>
    ...
    <div id="style-switch" class="collapse">
      ...
      <p><img src="../../../d19m59y37dris4.cloudfront.net/dark-admin-premium/1-4-6/img/template-mac.png" alt="" class="img-fluid"></p>
